...
| `ota` | Battery node simulation (voltage/current/SOC), light control, MachineInfo | Whole machine | Protocol fixtures + robot acceptance |
...
| `jihua_motor_quick_config/python` | Forward/reverse loop test | Motor / 485 | Cancellation/finally test + motor bench |
